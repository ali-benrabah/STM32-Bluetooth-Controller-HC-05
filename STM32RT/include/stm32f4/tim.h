...
#define TIM_IC2F_NOFILT	(0b0000 << 12)
#define TIM_IC2F_CK_2	(0b0001 << 12)
#define TIM_IC2F_CK_4	(0b0010 << 12)
#define TIM_IC2F_CK_8	(0b0011 << 12)
#define TIM_IC2F_DTS2_6	(0b0100 << 12)
#define TIM_IC2F_DTS2_8	(0b0101 << 12)
#define TIM_IC2F_DTS4_6	(0b0110 << 12)
#define TIM_IC2F_DTS4_8	(0b0111 << 12)
#define TIM_IC2F_DTS8_6	(0b1000 << 12)
#define TIM_IC2F_DTS8_8	(0b1001 << 12)
#define TIM_IC2F_DTS16_5	(0b1010 << 12)
#define TIM_IC2F_DTS16_6	(0b1011 << 12)
#define TIM_IC2F_DTS16_8	(0b1100 << 12)
#define TIM_IC2F_DTS32_5	(0b1101 << 12)
#define TIM_IC2F_DTS32_6	(0b1110 << 12)
#define TIM_IC2F_DTS32_8	(0b1111 << 12)
#define TIM_IC2PSC_1		(0b00 << 10)
#define TIM_IC2PSC_2		(0b01 << 10)
#define TIM_IC2PSC_4		(0b10 << 10)
#define TIM_IC2PSC_8		(0b11 << 10)
...
#define TIM_IC1F_NOFILT	(0b0000 << 4)
#define TIM_IC1F_CK_2	(0b0001 << 4)
#define TIM_IC1F_CK_4	(0b0010 << 4)
#define TIM_IC1F_CK_8	(0b0011 << 4)
#define TIM_IC1F_DTS2_6	(0b0100 << 4)
#define TIM_IC1F_DTS2_8	(0b0101 << 4)
#define TIM_IC1F_DTS4_6	(0b0110 << 4)
#define TIM_IC1F_DTS4_8	(0b0111 << 4)
#define TIM_IC1F_DTS8_6	(0b1000 << 4)
#define TIM_IC1F_DTS8_8	(0b1001 << 4)
#define TIM_IC1F_DTS16_5	(0b1010 << 4)
#define TIM_IC1F_DTS16_6	(0b1011 << 4)
#define TIM_IC1F_DTS16_8	(0b1100 << 4)
#define TIM_IC1F_DTS32_5	(0b1101 << 4)
#define TIM_IC1F_DTS32_6	(0b1110 << 4)
#define TIM_IC1F_DTS32_8	(0b1111 << 4)
#define TIM_IC1PSC_1		(0b00 << 0)
#define TIM_IC1PSC_2		(0b01 << 0)
#define TIM_IC1PSC_4		(0b10 << 0)
#define TIM_IC1PSC_8		(0b11 << 0)
...
#define TIM_IC4F_NOFILT	(0b0000 << 12)
#define TIM_IC4F_CK_2	(0b0001 << 12)
#define TIM_IC4F_CK_4	(0b0010 << 12)
#define TIM_IC4F_CK_8	(0b0011 << 12)
#define TIM_IC4F_DTS2_6	(0b0100 << 12)
#define TIM_IC4F_DTS2_8	(0b0101 << 12)
#define TIM_IC4F_DTS4_6	(0b0110 << 12)
#define TIM_IC4F_DTS4_8	(0b0111 << 12)
#define TIM_IC4F_DTS8_6	(0b1000 << 12)
#define TIM_IC4F_DTS8_8	(0b1001 << 12)
#define TIM_IC4F_DTS16_5	(0b1010 << 12)
#define TIM_IC4F_DTS16_6	(0b1011 << 12)
#define TIM_IC4F_DTS16_8	(0b1100 << 12)
#define TIM_IC4F_DTS32_5	(0b1101 << 12)
#define TIM_IC4F_DTS32_6	(0b1110 << 12)
#define TIM_IC4F_DTS32_8	(0b1111 << 12)
#define TIM_CCS4S_OUT	(0b00 << 8)
#define TIM_CCS4S_IN3	(0b01 << 8)
#define TIM_CCS4S_IN4	(0b10 << 8)
#define TIM_CCS4S_TRC	(0b11 << 8)
#define TIM_IC4PSC_1		(0b00 << 10)
#define TIM_IC4PSC_2		(0b01 << 10)
#define TIM_IC4PSC_4		(0b10 << 10)
#define TIM_IC4PSC_8		(0b11 << 10)
...
#define TIM_IC3F_NOFILT	(0b0000 << 4)
#define TIM_IC3F_CK_2	(0b0001 << 4)
#define TIM_IC3F_CK_4	(0b0010 << 4)
#define TIM_IC3F_CK_8	(0b0011 << 4)
#define TIM_IC3F_DTS2_6	(0b0100 << 4)
#define TIM_IC3F_DTS2_8	(0b0101 << 4)
#define TIM_IC3F_DTS4_6	(0b0110 << 4)
#define TIM_IC3F_DTS4_8	(0b0111 << 4)
#define TIM_IC3F_DTS8_6	(0b1000 << 4)
#define TIM_IC3F_DTS8_8	(0b1001 << 4)
#define TIM_IC3F_DTS16_5	(0b1010 << 4)
#define TIM_IC3F_DTS16_6	(0b1011 << 4)
#define TIM_IC3F_DTS16_8	(0b1100 << 4)
#define TIM_IC3F_DTS32_5	(0b1101 << 4)
#define TIM_IC3F_DTS32_6	(0b1110 << 4)
#define TIM_IC3F_DTS32_8	(0b1111 << 4)
#define TIM_IC3PSC_1		(0b00 << 0)
#define TIM_IC3PSC_2		(0b01 << 0)
#define TIM_IC3PSC_4		(0b10 << 0)
#define TIM_IC3PSC_8		(0b11 << 0)
...
#define TIM_LOCK(n)		((n) << 8)
#define TIM_DTG(n)		((n) << 0
